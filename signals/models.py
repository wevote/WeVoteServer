...
# Register signal save and delete receiver for CandidateCampaign, ContestMeasure, ContestOffice and Organization objects
# Updates ElasticSearch index with any change to the object.
# Exceptions are caught and logged, so the transaction goes through even if indexing fails.
