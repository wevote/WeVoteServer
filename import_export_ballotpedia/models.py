...
class BallotpediaApiCounter(models.Model):
    datetime_of_Action = models.DateTimeField(verbose_name='date of action', null=False, auto_now=False)
...
class BallotpediaApiCounterManager(models.Model):
    def create_counter_entry(selfself, kind_of_action, ballotpedia_election_id=0):
        try:
    ...
    def retrieve_daily_summaries(self, kind_of_action='', ballotpedia_election_id=0):
        daily_summaries = []
