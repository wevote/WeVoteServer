...
urlpatterns = [
    ...
    url(r'^retrieve_ballotpedia_ballots_for_voters_api_v4/$',
        views_admin.retrieve_ballotpedia_ballots_for_voters_api_v4_view,
        name='retrieve_ballotpedia_ballots_for_voters_api_v4'),
