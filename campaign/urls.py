...
urlpatterns = [
    ...
    re_path(r'^find_duplicate_campaignx_entries/$',
            views_admin.find_and_merge_duplicate_campaignx_entries_view,
            name='find_and_merge_duplicate_campaignx_entries'),
    ...
    re_path(r'^duplicates_list/$', views_admin.campaignx_duplicates_list_view, name='duplicates_list'),
    re_path(r'^not_duplicates/$', views_admin.campaignx_not_duplicates_view, name='not_duplicates'),
