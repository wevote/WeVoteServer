...
MIDDLE_INITIAL_WITH_PERIOD_SUBSTRINGS = []
for letter in LETTER_LIST:
    letter_substring = " {letter}. ".format(letter=letter)
    MIDDLE_INITIAL_WITH_PERIOD_SUBSTRINGS.append(letter_substring)

MIDDLE_INITIAL_WITHOUT_PERIOD_SUBSTRINGS = []
for letter in LETTER_LIST:
    letter_substring = " {letter} ".format(letter=letter)
    MIDDLE_INITIAL_WITHOUT_PERIOD_SUBSTRINGS.append(letter_substring)
