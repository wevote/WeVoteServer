...
urlpatterns = [
    ...
    re_path(r'^(?P<representative_id>[0-9]+)/refresh_twitter_representative_details/$',
        views_admin.refresh_twitter_representative_details_view, name='refresh_twitter_representative_details', ),
