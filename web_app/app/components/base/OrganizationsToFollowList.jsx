...
<div>
	...
	<div className="row">
		...
		<div className="pull-right col-xs-7 col-md-8">
			...
			<span className="small">
				@OrgName3 (<Link to="org_endorsements" params={{id: 2, org_id: 27}}>read more</Link>)
			</span>
		</div>
	</div>
	...
	<div className="row">
		...
		<div className="pull-right col-xs-7 col-md-8">
			...
			<span className="small">
				@OrgName4 (<Link to="org_endorsements" params={{id: 2, org_id: 27}}>read more</Link>)
			</span>
		</div>
	</div>
	...
	<div className="row">
		...
		<div className="pull-right col-xs-7 col-md-8">
			...
			<span className="small">
				@OrgName5 (<Link to="org_endorsements" params={{id: 2, org_id: 27}}>read more</Link>)
			</span>
		</div>
	</div>
	...
	<div className="row">
		...
		<div className="pull-right col-xs-7 col-md-8">
			...
			<span className="small">
				@OrgName6 (<Link to="org_endorsements" params={{id: 2, org_id: 27}}>read more</Link>)
			</span>
		</div>
	</div>
