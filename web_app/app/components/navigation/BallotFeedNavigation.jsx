    ...
    <div className="container-fluid bg-light box-skinny bottom-separator">
        <div className="row">
            <div className="col-xs-6 col-md-6 text-center">
                ...
                <Link to="add_friends" className="font-darkest fluff-left-narrow">Add Friends</Link></div>
            <div className="col-xs-6 col-md-6 text-center">
                <i className="icon-icon-more-opinions-2-2 icon-light icon-medium"></i>
                <Link to="ballot_opinions" className="font-darkest fluff-left-narrow">More Opinions</Link></div>
        </div>
    </div>
</div>
        );
