			...
			<div>
				...
				<div className="container-fluid well well-90">
					...
					<div>
						...
						<br />
						<Link to="add_friends_confirmed"><Button bsStyle="primary">Send</Button></Link><br />
                        <br />
                        <br />
                        <br />
                        OR<br />
						<Link to="add_friends_confirmed"><Button bsStyle="primary">Sign in with Facebook</Button></Link><br />
					</div>
				</div>
			</div>
		);
