...
export default class GuidesVoterDisplayPagePage extends React.Component {
	constructor(props) {
		super(props);
	}
        ...
        <ul className="list-group">
            <li className="list-group-item">
                <h3>
                    ...
                    Jane Doe Voter Guide<br />{/* TODO icon-person-placeholder */}
                </h3>
                @PersonName1&nbsp;&nbsp;&nbsp;See Website<br />
                5 of your friends follow Person Name<br />
                452 people follow<br />
                ...
                <AskOrShareAction link_text={"Share this Voter Guide"} />
                <br />
            </li>
        </ul>
        <ul className="list-group">
