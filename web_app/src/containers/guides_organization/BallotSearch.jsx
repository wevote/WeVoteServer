...
export default class BallotSearch extends React.Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
	    ...
	    return (
<div>
    <ListTitleNavigation header_text={"Create Voter Guide"} back_to_on={true} back_to_text={"< Back"} link_route={'guides_organization_choose_election'} />
