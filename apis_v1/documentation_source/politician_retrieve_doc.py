# apis_v1/documentation_source/politician_retrieve_doc.py
# Brought to you by We Vote. Be good.
# -*- coding: UTF-8 -*-


def politician_retrieve_doc_template_values(url_root):
    """
    ...
    template_values = {
        'api_name': 'politicianRetrieve',
        'api_slug': 'politicianRetrieve',
        'api_introduction':
            "",
        'try_now_link': 'apis_v1:politicianRetrieveView',
