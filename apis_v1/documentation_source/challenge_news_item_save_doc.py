# apis_v1/documentation_source/challenge_news_item_save_doc.py
# Brought to you by We Vote. Be good.
# -*- coding: UTF-8 -*-


def challenge_news_item_save_doc_template_values(url_root):
    """
    ...
    optional_query_parameter_list = [
        {
            'name':         'challenge_news_item_we_vote_id',
            'value':        'string',  # boolean, integer, long, string
            'description':  'The we_vote_id for the news item.',
        },
        {
            'name':         'challenge_news_subject',
            'value':        'string',  # boolean, integer, long, string
            'description':  'The subject of the news item.',
        },
        {
            'name':         'challenge_news_subject_changed',
            'value':        'boolean',  # boolean, integer, long, string
            'description':  'Are we trying to change the challenge news item\'s subject?',
        },
        {
            'name':         'challenge_news_text',
            'value':        'string',  # boolean, integer, long, string
            'description':  'The text of the news item.',
        },
        {
            'name':         'challenge_news_text_changed',
            'value':        'boolean',  # boolean, integer, long, string
            'description':  'Are we trying to change the challenge news item\'s text?',
        },
        {
            'name':         'in_draft_mode',
            'value':        'boolean',  # boolean, integer, long, string
    ...
    template_values = {
        'api_name': 'challengeNewsItemSave',
        'api_slug': 'challengeNewsItemSave',
        'api_introduction':
            "",
        'try_now_link': 'apis_v1:challengeNewsItemSaveView',
