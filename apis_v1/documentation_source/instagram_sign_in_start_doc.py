# apis_v1/documentation_source/instagram_sign_in_start_doc.py
# Brought to you by We Vote. Be good.
# -*- coding: UTF-8 -*-


def instagram_sign_in_start_doc_template_values(url_root):
    """
