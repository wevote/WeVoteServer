# apis_v1/documentation_source/challenge_participant_list_retrieve_doc.py
# Brought to you by We Vote. Be good.
# -*- coding: UTF-8 -*-


def challenge_participant_list_retrieve_doc_template_values(url_root):
    """
    ...
    template_values = {
        'api_name': 'challengeParticipantListRetrieve',
        'api_slug': 'challengeParticipantListRetrieve',
        'api_introduction':
            "",
        'try_now_link': 'apis_v1:challengeParticipantListRetrieveView',
