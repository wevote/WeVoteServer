...
urlpatterns = [
    ...
    url(r'^friendInvitationByFacebookSend/',
        views.friend_invitation_by_facebook_send_view, name='friendInvitationByFacebookSendView'),
    url (r'^friendInvitationByFacebookVerify/',
        views.friend_invitation_by_facebook_verify_view, name='friendInvitationByFacebookVerifyView'),
