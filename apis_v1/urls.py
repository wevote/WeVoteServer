...
urlpatterns = [
    ...
    url(r'^organizationFollow/', views.api_organization_follow_view, name='organizationFollowView'),
    url(r'^organizationFollowIgnore/', views.api_organization_follow_ignore_view, name='organizationFollowIgnoreView'),
    url(r'^organizationRetrieve/', views.organization_retrieve_view, name='organizationRetrieveView'),
    url(r'^organizationStopFollowing/', views.api_organization_stop_following_view, name='organizationStopFollowingView'),
