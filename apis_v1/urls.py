...
urlpatterns = [
    ...
    url(r'^appleValidateSignInWithAppleToken/', views_apple.validate_sign_in_with_apple_token,
    ...
    url(r'^ballotItemsSearchRetrieve/', views_ballot.ballot_items_search_retrieve_view,
    ...
    url(r'^campaignListRetrieve/', views_campaign.campaignx_list_retrieve_view, name='campaignListRetrieveView'),
    ...
    url(r'^candidateOrPoliticianRepairNames/',
    ...
    url(r'^friendInvitationInformation/',
    ...
    url(r'^officesVisitingSyncOut/', offices_visiting_sync_out_view, name='officesVisitingSyncOutView'),
    ...
    url(r'^organizationIndex/(?P<organization_incoming_domain>[:a-zA-Z0-9-_.]+)/(?P<campaign_main>[a-zA-Z0-9-_.]+)',
        views_organization.organization_index_view,
        name='organizationIndexView'),
    url(r'^organizationIndex/(?P<organization_incoming_domain>[a-zA-Z0-9-_.]+)',
        views_organization.organization_index_view,
        name='organizationIndexView'),
    url(r'^organizationIndex/', views_organization.organization_index_view, name='organizationIndexView'),
    ...
    url(r'^organizationStopIgnoring/',
    ...
    url(r'^voterGuidesFromFriendsUpcomingRetrieve/',
    ...
    url(r'^voterNotificationSettingsUpdate/',
    ...
    url(r'^docs/ballotItemHighlightsRetrieve/$',
    ...
    url(r'^docs/ballotItemsSearchRetrieve/$',
    ...
    url(r'^docs/campaignListRetrieve/$', views_docs.campaign_list_retrieve_doc_view, name='campaignListRetrieveDocs'),
    ...
    url(r'^docs/campaignStartSave/$', views_docs.campaign_save_doc_view, name='campaignStartSaveDocs'),
    url(r'^docs/campaignSupporterRetrieve/$',
        views_docs.campaign_supporter_retrieve_doc_view, name='campaignSupporterRetrieveDocs'),
    url(r'^docs/campaignSupporterSave/$',
    ...
    url(r'^docs/friendInvitationInformation/$',
    ...
    url(r'^docs/organizationPhotosSave/$',
    ...
    url(r'^docs/organizationStopIgnoring/',
    ...
    url(r'^docs/voterGuidesFromFriendsUpcomingRetrieve/$',
    ...
    url(r'^docs/voterNotificationSettingsUpdate/$',
