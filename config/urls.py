...
urlpatterns = [
    ...
    re_path(r'^elected_office/', include(('elected_office.urls', 'elected_office'), namespace="elected_office")),
    re_path(r'^elected_official_list/', include(('elected_official.urls', 'elected_official_list'), namespace="elected_official_list")),
