...
urlpatterns = [
    ...
    url(r'^repair_imported_names/$', views_admin.repair_imported_names_view, name='repair_imported_names'),
    url(r'^(?P<candidate_we_vote_id>wv[\w]{2}cand[\w]+)/edit/$',
