...
urlpatterns = [
    ...
    url(r'^(?P<ballot_item_id>[0-9]+)/delete_ballot_item/$', views_admin.ballot_item_delete_process_view,
    ...
    url(r'^(?P<ballot_returned_we_vote_id>wv[\w]{2}ballot[\w]+)/list_edit_by_we_vote_id/$',
