...
def donation_with_stripe_for_api(request, token, email, donation_amount, monthly_donation, voter_we_vote_id):
    ...
    try:
        ...
        print("stripe customer id " + stripe_customer_id + " and results['status'] " + results['status'])

        # if monthly_donation and positive_value_exists(stripe_customer_id):
        ...
        #     recurring_donation_plan_id = recurring_donation['recurring_donation_plan_id']
    ...
    results = {
        ...
        'monthly_donation_plan_id': recurring_donation_plan_id
