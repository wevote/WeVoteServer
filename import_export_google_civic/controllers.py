...
# from image.controllers import cache_master_and_resized_image, IMAGE_SOURCE_GOOGLE_CIVIC
# from import_export_batches.controllers_google_civic import store_google_civic_json_response_to_import_batch_system
import json
...
from polling_location.models import KIND_OF_LOG_ENTRY_ADDRESS_PARSE_ERROR, KIND_OF_LOG_ENTRY_API_END_POINT_CRASH, \
    KIND_OF_LOG_ENTRY_NO_OFFICES_HELD, KIND_OF_LOG_ENTRY_REPRESENTATIVES_RECEIVED, PollingLocationManager
...
def groom_and_store_office_held_with_representatives_google_civic_json(
    ...
    proceed_to_create_office_held = positive_value_exists(create_office_held_entry) and allowed_to_create_offices
    proceed_to_update_office_held = office_held_object_found and allowed_to_update_offices
...
def retrieve_google_civic_representatives_from_polling_location_api(
    ...
    if polling_location_found:
        ...
        # Not needed for Google Civic Representatives
        # if not latitude or not longitude:
        #     success = False
        #     status += "MISSING_LATITUDE_OR_LONGITUDE-GOOGLE_CIVIC "
        #     results = {
        #         'success':                                  success,
        #         'status':                                   status,
        #         'ballot_items_count':                       ballot_items_count,
        ...
        try:
            ...
            if 'offices' in representative_info_by_address_json:
                ...
                status += "NO_INCOMING_OFFICES_HELD_FOUND_GOOGLE_CIVIC "
