...
urlpatterns = [
    ...
    re_path(r'^update_ocd_id_state_mismatch_related_tables/',
            views_admin.update_ocd_id_state_mismatch_related_tables_view,
            name='update_ocd_id_state_mismatch_related_tables'),
