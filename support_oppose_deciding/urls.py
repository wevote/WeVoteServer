...
urlpatterns = [
    ...
    url(r'^cand/(?P<candidate_id>[0-9]+)/stopsupport/$',
    ...
    url(r'^cand/(?P<candidate_id>[0-9]+)/ask/$',
    ...
    url(r'^cand/(?P<candidate_id>[0-9]+)/stopasking/$',
