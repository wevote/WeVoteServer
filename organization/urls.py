...
urlpatterns = [
    ...
    url(r'^(?P<organization_id>[0-9]+)/pos/(?P<position_id>[0-9]+)/$',
        views_admin.organization_position_edit_view,
        name='organization_position_edit',),
    url(r'^(?P<organization_id>[0-9]+)/pos/new/$', views_admin.organization_position_new_view,
        name='organization_position_new',),
    url(r'^pos/edit_process/$', views_admin.organization_position_edit_process_view,
