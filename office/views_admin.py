...
def office_edit_view(request, office_id=0, contest_office_we_vote_id=""):
    ...
    ballotpedia_office_id = request.GET.get('ballotpedia_office_id', 0)
    ballotpedia_office_name = request.GET.get('ballotpedia_office_name', 0)
    ballotpedia_race_id = request.GET.get('ballotpedia_race_id', 0)
    ctcl_uuid = request.GET.get('ctcl_uuid', 0)
    district_id = request.GET.get('district_id', 0)
    messages_on_stage = get_messages(request)
    ocd_division_id = request.GET.get('ocd_division_id', 0)
    office_id = convert_to_int(office_id)
    google_civic_election_id = request.GET.get('google_civic_election_id', 0)
    google_civic_office_name = request.GET.get('google_civic_office_name', 0)
    google_civic_office_name2 = request.GET.get('google_civic_office_name2', 0)
    google_civic_office_name3 = request.GET.get('google_civic_office_name3', 0)
    google_civic_office_name4 = request.GET.get('google_civic_office_name4', 0)
    google_civic_office_name5 = request.GET.get('google_civic_office_name5', 0)
