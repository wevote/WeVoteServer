...
class QuickInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = QuickInfo
        fields = ('we_vote_id', 'language', 'info_text', 'info_html', 'ballot_item_label', 'site_to_credit',
...
class QuickInfoMasterSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('we_vote_id', 'kind_of_ballot_item',
                  'language', 'info_text', 'info_html', 'master_entry_name', 'site_to_credit', 'more_info_url',
